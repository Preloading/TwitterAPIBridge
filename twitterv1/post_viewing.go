...
func GetUserInfoFromTweetData(tweet blueskyapi.Post) bridge.TwitterUser {
	return bridge.TwitterUser{
		...
		ProfileImageURL:           configData.CdnURL + "/cdn/img/?url=" + url.QueryEscape(tweet.Author.Avatar) + "@jpeg:profile_bigger",
		ProfileImageURLHttps:      configData.CdnURL + "/cdn/img/?url=" + url.QueryEscape(tweet.Author.Avatar) + "@jpeg:profile_bigger",
		Location:                  "Twitter",
